...
$experience = [
    [
        'place of work' => 'Digital Security',
        'dateStart' => 'Январь 2023',
        'dateEnd' => 'Текущий момент',
        'description' => 'Дизайн сайтов и поддержка фирменного стиля проекта. Дизайн и верстка сайтов на Tilda. Дизайн e-mail рассылок. Создание визуала для соцсетей',
    ],
    [
        'place of work' => 'ЯндексТакси',
        'dateStart' => 'Сентябрь 2022',
        'dateEnd' => 'Декабрь 2022',
        'description' => 'Доставка пассажиров из пункта А в пункт В',
    ],
    [
        'place of work' => 'Булочная Ф.Вольчика',
        'dateStart' => 'Март 2022',
        'dateEnd' => 'Август 2022',
        'description' => 'Продавал самые вкусные булочки на свете',
    ],
    [
        'place of work' => 'Агенство Я+Ты',
        'dateStart' => 'Май 2021',
        'dateEnd' => 'Февраль 2022',
        'description' => 'Создавал дизайн проекты для украшения свадебных площадок',
    ],
];
?>
